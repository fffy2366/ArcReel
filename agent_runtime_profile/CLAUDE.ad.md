...
- 人脸在**产品原图或 sheet 里**时改构图无效——产品镜头的分镜生成（storyboard 路径）与 reference_video 路径的视频生成都会自动注入这些参考图，人脸随参考一起送达供应商（storyboard 路径的视频生成本身不再收产品参考，不受此限）；此时引导用户更换或裁剪产品原图（去掉人脸部分）后重新上传
