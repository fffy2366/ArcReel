MESSAGES = {
    ...
    "draft_video_not_found": "Draft video '{video_id}' does not exist",
    "draft_video_blocked": "Draft video '{video_id}' cannot be generated yet: {reason}",
    "draft_video_task_submitted": "Draft video generation task for '{video_id}' submitted",
    "draft_video_repair_not_needed": "Draft video '{video_id}' is not marked as needing repair",
    "draft_video_repair_task_submitted": "Draft video repair generation task for '{video_id}' submitted",
    "keyframe_not_found": "Keyframe '{keyframe_id}' does not exist",
    "keyframe_review_frame_not_generatable": "Keyframe '{keyframe_id}' is a review frame and cannot be generated directly",
    "keyframe_task_submitted": "Keyframe generation task for '{keyframe_id}' submitted",
