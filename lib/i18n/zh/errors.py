MESSAGES = {
    ...
    "tts_missing": "使用 TTS 交付前，请先为该单元生成旁白音频",
    "tts_generating": "旁白音频仍在生成；请等待完成后再使用 TTS 交付",
    "tts_stale": "旁白音频已过期；使用 TTS 交付前请重新生成",
    "tts_state_unavailable": "无法读取旁白音频状态；请先修复再使用 TTS 交付",
    "tts_duration_unavailable": "无法测量旁白音频时长；请修复或重新生成",
    "video_duration_unavailable": "无法测量生成视频是否容纳 {tts_duration:.1f}s 旁白；请重新生成视频",
    "video_shorter_than_tts": "生成视频仅 {video_duration:.1f}s，短于 {tts_duration:.1f}s 旁白；请重新生成；不要截断或加速语音",
