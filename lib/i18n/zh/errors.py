MESSAGES = {
    ...
    "draft_video_not_found": "视频草稿「{video_id}」不存在",
    "draft_video_blocked": "视频草稿「{video_id}」暂不能生成：{reason}",
    "draft_video_task_submitted": "视频草稿「{video_id}」生成任务已提交",
    "draft_video_repair_not_needed": "视频草稿「{video_id}」未标记为需修复",
    "draft_video_repair_task_submitted": "视频草稿「{video_id}」修复生成任务已提交",
    "keyframe_not_found": "关键帧「{keyframe_id}」不存在",
    "keyframe_review_frame_not_generatable": "关键帧「{keyframe_id}」是审核帧，不能直接生成",
    "keyframe_task_submitted": "关键帧「{keyframe_id}」生成任务已提交",
    ...
    "ref_duration_exceeded": "剧本编排 {total}s 超出 {model} 最大档位，已按 {duration}s 生成，成片短于剧本编排",
    "ref_duration_rounded_up": "剧本编排 {total}s 不在 {model} 的时长档位内，已按 {duration}s 生成，成片长于剧本编排",
