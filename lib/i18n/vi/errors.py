MESSAGES = {
    ...
    "draft_video_not_found": "Bản nháp video '{video_id}' không tồn tại",
    "draft_video_blocked": "Bản nháp video '{video_id}' chưa thể tạo: {reason}",
    "draft_video_task_submitted": "Đã gửi tác vụ tạo bản nháp video cho '{video_id}'",
    "draft_video_repair_not_needed": "Bản nháp video '{video_id}' chưa được đánh dấu cần sửa",
    "draft_video_repair_task_submitted": "Đã gửi tác vụ tạo bản sửa cho bản nháp video '{video_id}'",
    "keyframe_not_found": "Khung hình chính '{keyframe_id}' không tồn tại",
    "keyframe_review_frame_not_generatable": "Khung hình chính '{keyframe_id}' là khung kiểm duyệt và không thể tạo trực tiếp",
    "keyframe_task_submitted": "Đã gửi tác vụ tạo khung hình chính cho '{keyframe_id}'",
