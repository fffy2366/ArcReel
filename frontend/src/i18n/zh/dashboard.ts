...
export default {
  ...
  'project_type_template_title': '项目类型模板',
  'project_type_template_desc': '决定小说/剧本拆成画面时优先使用哪套节奏和镜头逻辑。',
  'project_type_auto': '自动识别',
  'project_type_auto_desc': '根据原文自动选择剧游、广告、剧情视频或解说剧。',
  'project_type_interactive_drama_game': '剧游',
  'project_type_interactive_drama_game_desc': '玩法入口、回归剧情、选择点、钩子。',
  'project_type_ad': '广告',
  'project_type_ad_desc': '前 3 秒钩子、痛点、反转、强转化。',
  'project_type_narrative_video': '剧情视频',
  'project_type_narrative_video_desc': '情绪推进、镜头节奏、人物关系。',
  'project_type_narrated_drama': '解说剧',
  'project_type_narrated_drama_desc': '旁白信息密度、画面承接、转场节奏。',
  'style_save': '保存风格',
  'style_saving': '保存中…',
  'style_clear': '取消风格',
  ...
  'mode_director_storyboard': '导演分镜',
  'mode_director_storyboard_desc': '基于剧情节拍规划导演镜头组，逐镜细化提示词，适合影视化分镜工作流。',
  ...
  'add_manxue_seedance_model': '添加满血API Seedance',
  ...
  'endpoint_manxue_video_display': '满血API 视频 (1ren KA)',
  'endpoint_manxue_seedance_video_display': '满血API 官方 Seedance',
  ...
  // ==================== 导演分镜预处理链路 ====================
  'director_pipeline_title': '导演分镜预处理链路',
  'director_pipeline_status_ready': '已生成',
  'director_pipeline_status_queued': '排队中',
  'director_pipeline_status_running': '生成中',
  'director_pipeline_status_failed': '失败',
  'director_pipeline_status_missing': '未生成',
  'director_pipeline_generating': '生成中',
  'director_pipeline_regenerate': '重新生成',
  'director_pipeline_missing_prompt': '请先在预处理里生成关键帧提示词。',
  'director_prompt_chain_title': '新提示词链路',
  'director_prompt_saving': '保存中',
  'director_prompt_save_first': '请先保存这段提示词再生成。',
  'director_negative_prompt_placeholder': '负面提示词...',
  'director_motion_guide_title': '9宫格动作引导图',
  'director_motion_guide_prompt_title': '9宫格动作引导图提示词',
  'director_motion_guide_prompt_placeholder': '9宫格动作引导图提示词...',
  'director_motion_guide_empty': '生成 9 宫格动作引导图后会显示在这里。',
  'director_motion_guide_generate': '生成 9 宫格',
  'director_keyframe_image_title': '关键帧图',
  'director_keyframe_prompt_title': '关键帧提示词',
  'director_keyframe_prompt_placeholder': '关键帧生图提示词...',
  'director_keyframe_image_empty': '生成关键帧图后会显示在这里。',
  'director_keyframe_generate': '生成关键帧',
  'director_start_keyframe_title': '视频起始关键帧',
  'director_start_keyframe_prompt_title': '视频起始关键帧提示词',
  'director_start_keyframe_prompt_placeholder': '视频起始关键帧生图提示词...',
  'director_start_keyframe_empty': '生成起始关键帧后会显示在这里。',
  'director_start_keyframe_prompt_empty': '请先创建起始关键帧提示词。',
  'director_start_keyframe_create': '创建关键帧提示词',
  'director_start_keyframe_create_first': '请先创建起始关键帧提示词。',
  'director_draft_video_title': '这一镜视频',
  'director_draft_video_empty': '生成这一镜视频后会显示在这里。',
  'director_draft_video_generate': '生成这一镜视频',
  'director_video_prompt_title': '视频提示词',
  'director_video_prompt_placeholder': '描述这一镜的视频动态...',
  'director_video_prompt_optimize': '提升提示词质量',
  'director_video_prompt_optimizing': '提升中',
  'director_video_prompt_optimized': '已提升：{{count}}/{{max}} 字，保存后生效。',
  'director_video_prompt_optimized_over_limit': '已提升但超长：{{count}}/{{max}} 字，请删减后保存。',
  'director_video_prompt_optimize_failed': '提升提示词失败：{{message}}',
  'director_video_prompt_save_first': '请先保存视频提示词。',
  'director_video_prompt_meta': 'start_image：{{startImage}} · 时长 {{duration}}s',
  'director_video_prompt_no_start_image': '首轮不强制',
  'director_video_prompt_missing': '请先在预处理里生成视频提示词。',
  'director_reference_pack_title': '本次提交给视频模型的素材参考图',
  'director_reference_pack_save': '保存素材',
  'director_reference_pack_save_first': '请先保存素材参考图。',
  'director_reference_pack_add_image': '添加参考图',
  'director_reference_pack_count': 'start_image {{start}} 张 + 参考图 {{refs}} 张 = 总计 {{total}}/{{max}}',
  'director_reference_pack_no_image': '无图',
  'director_reference_pack_added': '已添加',
  'director_reference_pack_asset_empty': '资产库里暂无可添加的角色、场景或道具图。',
  'director_reference_pack_path_missing': '未设置',
  'director_reference_pack_remove_image': '删除参考图',
  'director_reference_pack_empty': '暂无素材参考图；将仅用视频提示词提交。',
  'director_reference_video_url': '参考视频 URL',
  'director_reference_audio_url': '参考音频 URL',
  'director_reference_pack_add': '添加',
  'director_keyframe_error': '关键帧生成失败：{{message}}',
  'director_draft_video_error': '视频生成失败：{{message}}',
  'director_save_motion_guide_prompt': '保存动作引导图提示词',
  'director_save_keyframe_prompt': '保存关键帧提示词',
  'director_save_start_keyframe_prompt': '保存起始关键帧提示词',
  'director_save_video_prompt': '保存视频提示词',
  'director_keyframe_prompt_saved': '关键帧提示词已保存。',
  'director_keyframe_prompt_save_failed': '关键帧提示词保存失败。',
  'director_start_keyframe_prompt_created': '起始关键帧提示词已创建，请审核后生成。',
  'director_start_keyframe_prompt_create_failed': '起始关键帧提示词创建失败。',
  'director_keyframe_generation_submitted': '关键帧图生成任务已提交。',
  'director_keyframe_generation_failed': '关键帧图生成失败。',
  'director_video_prompt_saved': '视频提示词已保存。',
  'director_video_prompt_save_failed': '视频提示词保存失败。',
  'director_draft_video_generation_submitted': '这一镜视频生成任务已提交。',
  'director_draft_video_generation_failed': '这一镜视频生成失败。',
  // ==================== 镜头尾帧 ====================
  'end_frame_title': '尾帧',
