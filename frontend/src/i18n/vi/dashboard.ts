...
export default {
  ...
  'project_type_template_title': 'Mẫu loại dự án',
  'project_type_template_desc': 'Chọn nhịp và logic ống kính được ưu tiên khi tách tiểu thuyết hoặc kịch bản thành hình ảnh.',
  'project_type_auto': 'Tự nhận diện',
  'project_type_auto_desc': 'Tự chọn game drama, quảng cáo, video truyện hoặc phim kể chuyện theo văn bản gốc.',
  'project_type_interactive_drama_game': 'Game drama',
  'project_type_interactive_drama_game_desc': 'Điểm vào gameplay, trở lại cốt truyện, điểm lựa chọn, hook.',
  'project_type_ad': 'Quảng cáo',
  'project_type_ad_desc': 'Hook 3 giây đầu, điểm đau, đảo chiều, chuyển đổi mạnh.',
  'project_type_narrative_video': 'Video truyện',
  'project_type_narrative_video_desc': 'Đẩy cảm xúc, nhịp ống kính, quan hệ nhân vật.',
  'project_type_narrated_drama': 'Phim kể chuyện',
  'project_type_narrated_drama_desc': 'Mật độ lời dẫn, nối tiếp hình ảnh, nhịp chuyển cảnh.',
  ...
  'narration_speed_label': 'Tốc độ đọc (tùy chọn)',
  ...
  'mode_director_storyboard': 'Storyboard đạo diễn',
  'mode_director_storyboard_desc': 'Lập nhóm cảnh quay theo nhịp truyện, tinh chỉnh prompt từng cảnh cho quy trình điện ảnh.',
  ...
  'add_manxue_seedance_model': 'Thêm Manxue Seedance',
  ...
  // ==================== Quy trình phân cảnh đạo diễn ====================
  'director_pipeline_title': 'Quy trình phân cảnh đạo diễn',
  'director_pipeline_status_ready': 'Đã tạo',
  'director_pipeline_status_queued': 'Đang chờ',
  'director_pipeline_status_running': 'Đang tạo',
  'director_pipeline_status_failed': 'Thất bại',
  'director_pipeline_status_missing': 'Chưa tạo',
  'director_pipeline_generating': 'Đang tạo',
  'director_pipeline_regenerate': 'Tạo lại',
  'director_pipeline_missing_prompt': 'Hãy tạo prompt keyframe trong bước tiền xử lý trước.',
  'director_prompt_chain_title': 'Chuỗi prompt mới',
  'director_prompt_saving': 'Đang lưu',
  'director_prompt_save_first': 'Hãy lưu prompt này trước khi tạo.',
  'director_negative_prompt_placeholder': 'Prompt âm...',
  'director_motion_guide_title': 'Lưới hướng dẫn chuyển động 9 ô',
  'director_motion_guide_prompt_title': 'Prompt lưới hướng dẫn chuyển động 9 ô',
  'director_motion_guide_prompt_placeholder': 'Prompt lưới hướng dẫn chuyển động 9 ô...',
  'director_motion_guide_empty': 'Tạo lưới hướng dẫn chuyển động 9 ô để xem tại đây.',
  'director_motion_guide_generate': 'Tạo lưới 9 ô',
  'director_keyframe_image_title': 'Ảnh keyframe',
  'director_keyframe_prompt_title': 'Prompt keyframe',
  'director_keyframe_prompt_placeholder': 'Prompt tạo ảnh keyframe...',
  'director_keyframe_image_empty': 'Tạo ảnh keyframe để xem tại đây.',
  'director_keyframe_generate': 'Tạo keyframe',
  'director_start_keyframe_title': 'Keyframe bắt đầu video',
  'director_start_keyframe_prompt_title': 'Prompt keyframe bắt đầu video',
  'director_start_keyframe_prompt_placeholder': 'Prompt keyframe bắt đầu video...',
  'director_start_keyframe_empty': 'Tạo keyframe bắt đầu để xem tại đây.',
  'director_start_keyframe_prompt_empty': 'Hãy tạo prompt keyframe bắt đầu trước.',
  'director_start_keyframe_create': 'Tạo prompt keyframe',
  'director_start_keyframe_create_first': 'Hãy tạo prompt keyframe bắt đầu trước.',
  'director_draft_video_title': 'Video cảnh này',
  'director_draft_video_empty': 'Tạo video cảnh này để xem tại đây.',
  'director_draft_video_generate': 'Tạo video cảnh này',
  'director_video_prompt_title': 'Prompt video',
  'director_video_prompt_placeholder': 'Mô tả chuyển động video cho cảnh này...',
  'director_video_prompt_optimize': 'Cải thiện chất lượng prompt',
  'director_video_prompt_optimizing': 'Đang cải thiện',
  'director_video_prompt_optimized': 'Đã cải thiện: {{count}}/{{max}} ký tự. Lưu để áp dụng.',
  'director_video_prompt_optimized_over_limit': 'Đã cải thiện nhưng quá dài: {{count}}/{{max}} ký tự. Hãy chỉnh trước khi lưu.',
  'director_video_prompt_optimize_failed': 'Không cải thiện được prompt: {{message}}',
  'director_video_prompt_save_first': 'Hãy lưu prompt video trước.',
  'director_video_prompt_meta': 'start_image: {{startImage}} · thời lượng {{duration}}s',
  'director_video_prompt_no_start_image': 'không bắt buộc ở lượt đầu',
  'director_video_prompt_missing': 'Hãy tạo prompt video trong bước tiền xử lý trước.',
  'director_reference_pack_title': 'Ảnh tham chiếu gửi cho model video',
  'director_reference_pack_save': 'Lưu tài nguyên',
  'director_reference_pack_save_first': 'Hãy lưu ảnh tham chiếu trước.',
  'director_reference_pack_add_image': 'Thêm ảnh tham chiếu',
  'director_reference_pack_count': 'start_image {{start}} + tham chiếu {{refs}} = {{total}}/{{max}}',
  'director_reference_pack_no_image': 'Không có ảnh',
  'director_reference_pack_added': 'Đã thêm',
  'director_reference_pack_asset_empty': 'Thư viện chưa có ảnh nhân vật, bối cảnh hoặc đạo cụ để thêm.',
  'director_reference_pack_path_missing': 'Thiếu đường dẫn',
  'director_reference_pack_remove_image': 'Xóa ảnh tham chiếu',
  'director_reference_pack_empty': 'Chưa có ảnh tham chiếu; chỉ gửi prompt video.',
  'director_reference_video_url': 'URL video tham chiếu',
  'director_reference_audio_url': 'URL audio tham chiếu',
  'director_reference_pack_add': 'Thêm',
  'director_keyframe_error': 'Tạo keyframe thất bại: {{message}}',
  'director_draft_video_error': 'Tạo video thất bại: {{message}}',
  'director_save_motion_guide_prompt': 'Lưu prompt hướng dẫn chuyển động',
  'director_save_keyframe_prompt': 'Lưu prompt keyframe',
  'director_save_start_keyframe_prompt': 'Lưu prompt keyframe bắt đầu',
  'director_save_video_prompt': 'Lưu prompt video',
  'director_keyframe_prompt_saved': 'Đã lưu prompt keyframe.',
  'director_keyframe_prompt_save_failed': 'Không lưu được prompt keyframe.',
  'director_start_keyframe_prompt_created': 'Đã tạo prompt keyframe bắt đầu. Hãy kiểm tra trước khi tạo ảnh.',
  'director_start_keyframe_prompt_create_failed': 'Không tạo được prompt keyframe bắt đầu.',
  'director_keyframe_generation_submitted': 'Đã gửi tác vụ tạo ảnh keyframe.',
  'director_keyframe_generation_failed': 'Không gửi được tác vụ tạo ảnh keyframe.',
  'director_video_prompt_saved': 'Đã lưu prompt video.',
  'director_video_prompt_save_failed': 'Không lưu được prompt video.',
  'director_draft_video_generation_submitted': 'Đã gửi tác vụ tạo video cảnh này.',
  'director_draft_video_generation_failed': 'Không gửi được tác vụ tạo video cảnh này.',
  // ==================== Khung hình cuối ====================
