...
export default {
  ...
  'project_type_template_title': 'Project type template',
  'project_type_template_desc': 'Choose which pacing and shot logic to prioritize when splitting a novel or script into visuals.',
  'project_type_auto': 'Auto detect',
  'project_type_auto_desc': 'Choose game drama, ad, narrative video, or narrated drama from the source text.',
  'project_type_interactive_drama_game': 'Game drama',
  'project_type_interactive_drama_game_desc': 'Gameplay entry, story return, choice points, hooks.',
  'project_type_ad': 'Ad',
  'project_type_ad_desc': 'First 3-second hook, pain point, reversal, strong conversion.',
  'project_type_narrative_video': 'Narrative video',
  'project_type_narrative_video_desc': 'Emotional progression, shot rhythm, character relationships.',
  'project_type_narrated_drama': 'Narrated drama',
  'project_type_narrated_drama_desc': 'Voiceover density, visual continuity, transition rhythm.',
  ...
  'task_progress_failed': 'Subtask failed',
  'task_progress_ended': 'Subtask ended',
  ...
  'product_ref_uploaded_toast': 'Product photo uploaded',
  ...
  'narration_speed_label': 'Speech rate (optional)',
  ...
  'update_product_failed': 'Failed to update product: {{message}}',
  'product_task_submitted_toast': 'Reference sheet task for product "{{name}}" submitted',
  'product_added_toast': 'Product "{{name}}" added',
  ...
  'ad_short_video_mode': 'Ad / Short Video Mode',
  ...
  'mode_director_storyboard': 'Director Storyboard',
  'mode_director_storyboard_desc': 'Plan director shot groups based on story beats, refine prompts per shot for cinematic workflow.',
  ...
  'add_manxue_seedance_model': 'Add Manxue Seedance',
  ...
  'endpoint_manxue_video_display': 'Manxue API Video (1ren KA)',
  'endpoint_manxue_seedance_video_display': 'Manxue API Official Seedance',
  ...
  'reference_duration_confirm_title': "Generated length won't match the script",
  ...
  'reference_duration_note_longer': 'The model accepts only fixed length options. The clip is delivered at the requested length and is not trimmed back to the script.',
  ...
  'grid_regenerate_busy': 'This grid is already generating, please try again shortly',
  ...
  'batch_generate_narration': 'Generate episode narration',
  ...
  'media_narration_title': 'Narration',
  'media_generate_narration': 'Generate narration',
  'media_regenerate_narration': 'Regenerate narration',
  ...
  'ad_init_subtitle': 'Upload product photos, fill in product info and your creative brief to get started',
  'ad_init_product_section': 'Product Info (optional)',
  'ad_init_product_name_label': 'Product Name',
  'ad_init_product_images_label': 'Product Photos',
  'ad_init_product_images_hint': 'Multiple allowed; originals are kept as the fidelity baseline',
  'ad_init_product_desc_label': 'Product Description',
  ...
  // ==================== Director storyboard pipeline ====================
  'director_pipeline_title': 'Director storyboard pipeline',
  'director_pipeline_status_ready': 'Ready',
  'director_pipeline_status_queued': 'Queued',
  'director_pipeline_status_running': 'Generating',
  'director_pipeline_status_failed': 'Failed',
  'director_pipeline_status_missing': 'Missing',
  'director_pipeline_generating': 'Generating',
  'director_pipeline_regenerate': 'Regenerate',
  'director_pipeline_missing_prompt': 'Generate keyframe prompts in preprocessing first.',
  'director_prompt_chain_title': 'New prompt chain',
  'director_prompt_saving': 'Saving',
  'director_prompt_save_first': 'Save this prompt before generating.',
  'director_negative_prompt_placeholder': 'Negative prompt...',
  'director_motion_guide_title': '9-grid motion guide',
  'director_motion_guide_prompt_title': '9-grid motion guide prompt',
  'director_motion_guide_prompt_placeholder': '9-grid motion guide prompt...',
  'director_motion_guide_empty': 'Generate the 9-grid motion guide to preview it here.',
  'director_motion_guide_generate': 'Generate 9-grid',
  'director_keyframe_image_title': 'Keyframe image',
  'director_keyframe_prompt_title': 'Keyframe prompt',
  'director_keyframe_prompt_placeholder': 'Keyframe image prompt...',
  'director_keyframe_image_empty': 'Generate the keyframe image to preview it here.',
  'director_keyframe_generate': 'Generate keyframe',
  'director_start_keyframe_title': 'Video start keyframe',
  'director_start_keyframe_prompt_title': 'Video start keyframe prompt',
  'director_start_keyframe_prompt_placeholder': 'Video start keyframe prompt...',
  'director_start_keyframe_empty': 'Generate the start keyframe to preview it here.',
  'director_start_keyframe_prompt_empty': 'Create a start keyframe prompt first.',
  'director_start_keyframe_create': 'Create keyframe prompt',
  'director_start_keyframe_create_first': 'Create the start keyframe prompt first.',
  'director_draft_video_title': 'This shot video',
  'director_draft_video_empty': 'Generate this shot video to preview it here.',
  'director_draft_video_generate': 'Generate this shot video',
  'director_video_prompt_title': 'Video prompt',
  'director_video_prompt_placeholder': 'Describe the motion for this shot...',
  'director_video_prompt_optimize': 'Improve prompt quality',
  'director_video_prompt_optimizing': 'Improving',
  'director_video_prompt_optimized': 'Improved: {{count}}/{{max}} chars. Save to apply.',
  'director_video_prompt_optimized_over_limit': 'Improved but too long: {{count}}/{{max}} chars. Edit before saving.',
  'director_video_prompt_optimize_failed': 'Could not improve the prompt: {{message}}',
  'director_video_prompt_save_first': 'Save the video prompt first.',
  'director_video_prompt_meta': 'start_image: {{startImage}} · duration {{duration}}s',
  'director_video_prompt_no_start_image': 'not required for first pass',
  'director_video_prompt_missing': 'Generate video prompts in preprocessing first.',
  'director_reference_pack_title': 'Reference images submitted to the video model',
  'director_reference_pack_save': 'Save assets',
  'director_reference_pack_save_first': 'Save reference assets first.',
  'director_reference_pack_add_image': 'Add reference image',
  'director_reference_pack_count': 'start_image {{start}} + references {{refs}} = {{total}}/{{max}}',
  'director_reference_pack_no_image': 'No image',
  'director_reference_pack_added': 'Added',
  'director_reference_pack_asset_empty': 'No character, scene, or prop images are available in the asset library.',
  'director_reference_pack_path_missing': 'Missing path',
  'director_reference_pack_remove_image': 'Remove reference image',
  'director_reference_pack_empty': 'No reference images yet; only the video prompt will be submitted.',
  'director_reference_video_url': 'Reference video URL',
  'director_reference_audio_url': 'Reference audio URL',
  'director_reference_pack_add': 'Add',
  'director_keyframe_error': 'Keyframe generation failed: {{message}}',
  'director_draft_video_error': 'Video generation failed: {{message}}',
  'director_save_motion_guide_prompt': 'Save motion guide prompt',
  'director_save_keyframe_prompt': 'Save keyframe prompt',
  'director_save_start_keyframe_prompt': 'Save start keyframe prompt',
  'director_save_video_prompt': 'Save video prompt',
  'director_keyframe_prompt_saved': 'Keyframe prompt saved.',
  'director_keyframe_prompt_save_failed': 'Could not save the keyframe prompt.',
  'director_start_keyframe_prompt_created': 'Start keyframe prompt created. Review it before generation.',
  'director_start_keyframe_prompt_create_failed': 'Could not create the start keyframe prompt.',
  'director_keyframe_generation_submitted': 'Keyframe image task submitted.',
  'director_keyframe_generation_failed': 'Could not submit keyframe image generation.',
  'director_video_prompt_saved': 'Video prompt saved.',
  'director_video_prompt_save_failed': 'Could not save the video prompt.',
  'director_draft_video_generation_submitted': 'Shot video task submitted.',
  'director_draft_video_generation_failed': 'Could not submit shot video generation.',
  // ==================== Shot end frame ====================
